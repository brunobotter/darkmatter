...
import br.com.darkmatter.V_HEIGHT
...
private const val UPDATE_RATE: Float = 1 / 25f
private const val HOR_ACCELERATION: Float = 16.5f
private const val VER_ACCELERATION: Float = 2.25f
private const val MAX_VER_NEG_PLAYER_SPEED: Float = 0.75f
private const val MAX_VER_POS_PLAYER_SPEED: Float = 5f
private const val MAX_HOR_SPEED: Float = 5.5f
...
class MoveSystem :
    ...
    override fun processEntity(entity: Entity, deltaTime: Float) {
        ...
        require(move != null) { "Entity |entity| must have a FacingComponent. entity=$entity" }
    ...
    private fun moveEntity(transform: TransformComponent, move: MoveComponent, deltaTime: Float) {
        ...
        transform.position.y = MathUtils.clamp(
            ...
            1f, V_HEIGHT + 1f - transform.size.y
        )
    }
